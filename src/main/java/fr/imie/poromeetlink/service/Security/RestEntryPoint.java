...
public class RestEntryPoint implements AuthenticationEntryPoint {
    ...
    public RestEntryPoint(ObjectMapper objectMapper) {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
        ...
        BasicErrorEntity errorEntity = new BasicErrorEntity(HttpStatus.valueOf(response.getStatus()), authException.getMessage(), request.getRequestURI());
